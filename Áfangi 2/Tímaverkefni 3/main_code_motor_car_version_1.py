...
def turn(turn_time=turn_duration, direction):
    if direction == "right":
        drive_motor_a_forward(512) # Adjustable from 1-1024 (512 half speed)
        drive_motor_a_backward(512)
    elif direction == "left":
        drive_motor_a_backward(512)
        drive_motor_b_forward(512)
...
while True:
    ...
    # ----- Drive motors forward for two seconds ----- #
    drive_motor_a_forward()
    drive_motor_b_forward()
    time.sleep(2)
    stop_motor_a()
    ...
    # ----- Drive motors backwards for two seconds ----- #
    drive_motor_a_backward()
    drive_motor_b_backward()
    time.sleep(2)
    stop_motor_a()
